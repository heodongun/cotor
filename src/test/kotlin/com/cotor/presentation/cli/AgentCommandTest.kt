...
/**
 * File overview for AgentCommandTest.
 *
 * This file belongs to the test suite that documents expected behavior and protects against regressions.
 * It groups declarations around agent command test so readers can find the owning runtime area quickly.
...
class AgentCommandTest : FunSpec({
    ...
    test("agent add opencode uses nemotron default model") {
        ...
        val result = AgentCommand().test("add opencode --config $config --local --yes")
